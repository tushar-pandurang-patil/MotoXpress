  ...
  return (
    <div className="home-page">
      ...
      <div className="content">
        <h1 className="display-5">Welcome to MotoXpress</h1>
      ...
      <div className="container text-center my-5 section">
        ...
        <p>If you have any questions or need further assistance, feel free to <a href="/contact-us" className="link-custom">Contact Us</a>.</p>
      </div>
      ...
      <div className="container text-center my-5 section">
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <p>Fill out the booking form with your details and preferred rental period.</p>
          </div>
          <div className="col-md-4">
            <div className="feature-icon">
